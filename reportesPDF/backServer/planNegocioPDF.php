...
//---Aqui tabla acciones
	...
	$pdf->SetTextColor(240, 255, 240); //Letra color blanco
	$pdf->Ln();
	$pdf->Cell(60,6,utf8_decode('Acción:'),1,0,'C',1);
	$pdf->Cell(50,6,'Indicador de logro:',1,0,'C',1);
	...
	while ($resRpn=$consulTabAcciones->fetch_assoc()) {
		...
		$pdf->Cell(60,6,utf8_decode($resRpn['accion_rpn']),1,0,'C', $bandera);
		//$pdf->MultiCell(30,6,utf8_decode($resRpn['accion_rpn']),1,"L",false);
		$pdf->Cell(50,6,utf8_decode($resRpn['indilogro_rpn']),1,0,'C', $bandera);
