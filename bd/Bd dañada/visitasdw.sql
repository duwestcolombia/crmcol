...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-09-2016 a las 17:03:57
...
(1, 1, 1, 1, 1, 0, 1, 1, 1, 1, 0, '14789633', 'jluna');
...
('aavendano', 'Alvaro Avendaño Mora', 'Duwest01*', 9, 4),
('acortes', 'Ana Maria Cortes Amaya', 'Duwest01*', 6, 3),
('agamboa', 'Antonio Gamboa', 'Duwest01*', 6, 3),
('ahernandez', 'Alberto Hernandez Anaya', 'Duwest01*', 9, 4),
('anunez', 'Argemiro Nuñez Romero', 'Duwest01*', 4, 3),
('apacheco', 'Armando Javier Pacheco', 'Duwest01*', 1, 3),
('arodriguez', 'Julieth Andrea Rodriguez Pardo', 'Duwest01*', 6, 3),
('bmora', 'Blas Mauricio Mora Ubaque', 'Duwest01*', 3, 4),
('caraque', 'Carlos Araque', 'Duwest01*', 9, 4),
('cpedraza', 'Carlos Enrique Pedraza Dueñas', 'Duwest01*', 2, 3),
('dcardona', 'Daniel Cardona', 'Duwest01*', 4, 3),
('dchavez', 'Dario Ricardo Chavez Burbano', 'Duwest01*', 8, 4),
('dmatiz', 'Diego Alfonso Matiz Barbosa', 'Duwest01*', 3, 4),
('dperdomo', 'Diego Perdomo Rojas', 'Duwest01*', 10, 3),
('dsilva', 'Doris Silva', 'Duwest01*', 10, 3),
('dzambrano', 'david zambrano', 'Cota$8193*', 1, 1),
('eyepez', 'Edison Antonio Yepez Mena', 'Duwest01*', 8, 4),
('gmarentes', 'Gloria Yaneth Marentes Prada', 'Duwest01*', 3, 3),
('gmontealegre', 'Gilmar Smith Montealegre Dussan', 'Duwest01*', 8, 4),
('jbarajas', 'Jairo Edimer Barajas Ortiz', 'Duwest01*', 10, 3),
('jluna', 'Jenny Zuliette Luna Jara', 'Duwest01*', 3, 4),
('jluque', 'Juan Luque', 'Duwest01*', 6, 3),
('jrubio', 'Jeferson Mauricio Rubio Romero', 'Duwest01*', 10, 3),
('jvalencia', 'Jorge Hernán Valencia', 'Duwest01*', 4, 3),
('jvillamil', 'Juan Pablo Villamil Camargo', 'Duwest01*', 2, 3),
('lbolanos', 'Luis Gerardo Bolaños Rodriguez', 'Duwest01*', 8, 4),
('lcarmona', 'Luz Andrea Carmona Valencia', 'Duwest01*', 4, 4),
('lrodriguez', 'Narda Lorena Rodriguez Cohecha', 'Duwest01*', 10, 3),
('mdiaz', 'Maria Fernanda Diaz', 'Duwest01*', 10, 3),
('mmena', 'Manuel Mena', 'Duwest01*', 1, 4),
('mserna', 'Mauricio Arnoby Serna Pelaez', 'Duwest01*', 1, 3),
('ncardona', 'Yensi Natalia Cardona Muñoz', 'Duwest01*', 4, 3),
('omendez', 'Oscar Mendez', 'Duwest01*', 7, 3),
('ovanegas', 'Oscar Ivan Vanegas Castellanos', 'Duwest01*', 2, 4),
('plopez', 'Paula Andrea Lopez Ramirez', 'Duwest01*', 5, 3),
('ravila', 'Ricardo Alonso Avila Avila', 'Duwest01*', 1, 3),
('rticora', 'Rene Albert Ticora Lozano', 'Duwest01*', 3, 4),
('rvelasquez', 'Raul Mauricio Velasquez Londoño', 'Duwest01*', 3, 3),
('scastro', 'Sebastian Castro Garcia', 'Duwest01*', 5, 4),
('wbarreto', 'Wilson Alcides Barreto Farfan', 'Duwest01*', 3, 4),
('wcruz', 'Wilmer Herney Cruz Ausecha', 'Duwest01*', 4, 3),
('wnova', 'Wilmar Alfonso Nova Castellanos', 'Duwest01*', 2, 4),
('ylopez', 'Yeiler Canicio López Graciano', 'Duwest01*', 1, 4);
