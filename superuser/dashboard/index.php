...
<body>
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="view/perfilView.php"><i class="fa fa-fw fa-user"></i> Perfil</a>
                        </li>
                        <li>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li id="">
                                <a href="view/repVisitaView.php">Reporte de visitas</a>
                            </li>
                            <li>
                                <a href="view/repProgramacionView.php">Reporte programacion semanal</a>
                            </li>
                            <li>
                                <a href="../vistaPlanNegocio.php">Reporte planes de negocio</a>
                            </li>
                            <li>
                                <a href="../vistaPlanNegocio.php">Reporte uso de la plataforma</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="demo2" class="collapse">
                            <li id="">
                                <a href="view/grafUsoPlataforma.php">Uso de la plataforma</a>
                            </li>
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="demo3" class="collapse">
                            <li id="">
                                <a href="../rprogramacion.php"><i class="fa fa-user" aria-hidden="true"></i> Usuarios</a>
                            </li>
                            <li>
                                <a href="view/consulClientesView.php" ><i class="fa fa-users" ></i> Clientes</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul id="demo4" class="collapse">
                            <li>
                                <a href="view/consulClientesView.php" ><i class="fa fa-cloud-upload" aria-hidden="true" ></i> Carga Masiva</a>
                            </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Planes de negocio</strong>  <a href="http://startbootstrap.com/template-overviews/sb-admin-2" class="alert-link">SB Admin 2</a> for additional features!
                        </div>
                    </div>
                </div>-->
                <!-- /.row -->
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div>Visitas Programadas en este mes!</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                ...
                <div class="row" >
                    <div class="col-lg-12">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title" id="lbl_title"><i class="fa fa-map-marker"></i> Tu estas aqui.</h3>
                            </div>
                            <div class="panel-body">
    ...
    <!-- DE ESTA MANERA CARGO EL MAPA SI USO CERTIFICADOS HTTPS-->
   <!-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA2fWA5HmlEkCYSJbd9jf4Ush6aez020NI&callback=myMap" async defer type="text/javascript"></script>-->

    <!-- DE ESTA MANERA CARGO EL MAPA SI USO CERTIFICADOS HTTP-->
    <script async defer 
    src="http://maps.googleapis.com/maps/api/js?key=AIzaSyA2fWA5HmlEkCYSJbd9jf4Ush6aez020NI&callback=myMap" type="text/javascript">
    </script>
