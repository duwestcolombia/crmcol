...
<head>
	...
	<script type="text/javascript" src="../js/admin/cargareportprogramacion.js"></script>
	...
	$(document).ready(function(){
		Push.create("Novedad Programacion de Visitas!", {
				...
				<div class="container-fluid">
							...
							<div class="panel-body">
								<div class="row">
									...
									<div class="col-xs-6 col-md-3">
										...
										<input type="datetime-local" name="fecha_inicio" id="fecha_inicio" class="form-control" required="required" >
									</div>
									<div class="col-xs-6 col-md-3">
										<label for="exampleInputEmail2">Fecha de Fin</label>
										<input type="datetime-local" name="fecha_fin" id="fecha_fin" class="form-control" required="required">
									</div>
								</div>
								<br>
								<input type="button" class="btn btn-success" value="Buscar" id="btn_buscar" onClick="cargaProgramacionVisitas();">
								<input type="button" id="btn_exportar" class="btn btn-warning" value="Exportar a Excel" onClick="">
							</div>
						</div>
					</form>
					...
					<script>
					    $("#btn_exportar").click(function(e) {
					        window.open('data:application/vnd.ms-excel,' + encodeURIComponent($('#tab_rprogramacion').html()));
					        e.preventDefault();
					    });
					    </script>
			</section>
